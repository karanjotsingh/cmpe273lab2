...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.pollservice.PollRequest,
      io.grpc.examples.pollservice.PollResponse> METHOD_CREATE_POLL =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "CreatePoll",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.pollservice.PollRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.pollservice.PollResponse.PARSER));
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.examples.pollservice.PollRequest,
        io.grpc.examples.pollservice.PollResponse> createPoll;

    private PollServiceServiceDescriptor() {
      createPoll = createMethodDescriptor(
          "grpc.example.pollservice.PollService", METHOD_CREATE_POLL);
    }

    @SuppressWarnings("unchecked")
    private PollServiceServiceDescriptor(
        java.util.Map<java.lang.String, io.grpc.MethodDescriptor<?, ?>> methodMap) {
      createPoll = (io.grpc.MethodDescriptor<io.grpc.examples.pollservice.PollRequest,
          io.grpc.examples.pollservice.PollResponse>) methodMap.get(
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.examples.pollservice.PollRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.pollservice.PollResponse> responseObserver);
  }

  public static interface PollServiceBlockingClient {

    public io.grpc.examples.pollservice.PollResponse createPoll(io.grpc.examples.pollservice.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.pollservice.PollResponse> createPoll(
        io.grpc.examples.pollservice.PollRequest request);
  }
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("grpc.example.pollservice.PollService")
      .addMethod(createMethodDefinition(
          METHOD_CREATE_POLL,
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.examples.pollservice.PollRequest,
                io.grpc.examples.pollservice.PollResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.examples.pollservice.PollRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.examples.pollservice.PollResponse> responseObserver) {
